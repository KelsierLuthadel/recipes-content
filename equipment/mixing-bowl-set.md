...
image: resources/mixing-bowls.jpg
tagline: Three sizes of stainless steel bowl that nest inside each other. The kitchen's most-used containers.
---
...
**Premium**: a set of glass bowls (Pyrex or borosilicate) PLUS the stainless set. Glass shows what's in it (useful when you forget what's marinating), is microwave-safe, oven-safe to moderate temperatures, but breaks. Stainless does everything else.

Look for: **nest into each other** (saves cabinet space), **flat bottoms** (sit stable on the counter), **at least three sizes** (1L for dressings, 3L for the everyday prep, 5L for dough and large batters). Wide rims (rolled lip) make for easier pouring.
...
**The large bowl** is for bread dough (it'll double in size, you need the headroom), big salads, brining a turkey.

For whisking: set the bowl on a damp cloth or rubber shelf liner to stop it sliding. Or get the silicone-base bowls if you whisk a lot.
