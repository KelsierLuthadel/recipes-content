...
image: resources/instant-read-thermometer.jpg
tagline: The difference between a perfectly cooked chicken and a dry one. Cheaper than a single meal in a restaurant and more useful than half the gadgets in the drawer.
---
...
**Premium (£200+)**: Thermapen IR (with infrared surface reading) or Combustion Predictive Thermometer (Bluetooth, runs in the meat, predicts done-time). Mostly nice-to-have.

For most home cooks, the **budget tier is fine**. Go to the good tier if you cook meat often and want the 1-second read instead of 5 seconds.

Look for: **digital probe** (not dial — dial thermometers drift and lie), **2–5 second read time** (faster is better but anything under 10 seconds works), **temperature range up to 300°C** (oils, candy work), **waterproof or splash-proof rating** (kitchens are wet places), **±1°C or better accuracy**.
...
**Target temperatures**:
- Chicken (whole or breast): 74°C (165°F) — kills salmonella in seconds at this temp.
- Chicken (thigh): 77°C (170°F) — fat renders, tendon softens.
- Pork: 63°C (145°F) for medium, 71°C (160°F) for medium-well. Trichinosis isn't a real risk in modern Western pork.
- Beef and lamb steak: 52°C (rare), 57°C (medium-rare), 63°C (medium), 71°C (medium-well).
- Fish: 52–60°C depending on species and preference.

**Account for carryover cooking**: temperature rises 2–5°C after pulling from the heat. Pull at 3°C below target for big roasts, on-target for smaller pieces.
