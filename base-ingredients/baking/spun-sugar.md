...
## Overview
Spun sugar is the building block for theatrical dessert garnishes: caramelised sugar pulled into gossamer threads and draped into golden nests, halos or lacy veils that crown a plated dessert as the final flourish. It's pure sugar and pure technique. The timing window is tight and humidity is the enemy. Rig two chopsticks taped to the counter edge projecting 15 cm out, weighted down by a baking sheet, with parchment laid below. Melt caster sugar in a heavy pan over medium-high, adding it in handfuls so the pan melts evenly, then let the heat carry it to a pale amber (darker turns bitter). Dip the pan base in iced water to halt cooking, rest two minutes, then flick the caramel from two forks over the chopsticks to layer threads into a nest. Lift the nest off in one piece and plate at the last moment.
