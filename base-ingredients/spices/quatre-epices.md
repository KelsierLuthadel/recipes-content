...
## Overview
Quatre épices is the four-spice blend behind French charcuterie, the seasoning that flavours pâtés, terrines, sausages, rillettes and slow-cooked meat dishes. The four components, ground black pepper, cloves, nutmeg and ginger, go in equal parts by weight, and that strict 1:1:1:1 ratio is the whole structure: pepper for heat, cloves and nutmeg for warmth, ginger for a bright lift. The character is refined and restrained rather than bold; it works underneath the meat, not over it. Use whole spices if you can, especially freshly grated nutmeg, which loses character within weeks of opening. Stir equal weights together, sieve fine so terrine slices look even, and store airtight away from light. Freshness matters more here than in any other blend, so make small batches. Use a quarter to half a teaspoon per medium terrine.
