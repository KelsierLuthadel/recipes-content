...
## Overview
Spezi is one of those drinks that started as a hack and graduated into an institution. The name comes from a 1950s Augsburg brewer who trademarked "Paulaner Spezi" for his bottled cola-and-orange mix; the trademark still belongs to Paulaner, but the generic name (and the home preparation) is shared across all of Bavaria and Austria. The build couldn't be simpler: equal parts cola and orange soda, poured over a tall glass of ice with a wedge of lemon. The result is rounder and more interesting than either component alone: the cola gives the deep caramel and acid, the orange gives a fruity sweetness, and the two together taste somehow less artificial than either on its own. Order it at any Bavarian beer garden and they'll pour it from two taps simultaneously, which is the proper way; at home you can do it from two bottles or cans. Available bottled in Germany under various brands (Mezzo Mix is Coca-Cola's version, Paulaner Spezi the original) but the homemade version costs a third of the bottled one and tastes identical.
