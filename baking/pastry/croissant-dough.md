...
## Overview
Croissant dough is the building block for croissants, pains au chocolat, pains aux raisins and the rest of the laminated breakfast pastry family: an enriched yeasted dough wrapped around a slab of butter, then rolled and folded three times so the butter splits into 27 wafer-thin layers separated by 27 layers of dough. As the pastry bakes, the water in the dough turns to steam, the butter melts and the layers puff apart into the airy crisp shattering interior that defines a proper croissant. The whole thing turns on temperature. Butter and dough have to be at the same firmness when you roll them together (if the butter is colder it shatters into chunks rather than spreading evenly; if it's warmer it melts and bleeds into the dough, ruining the lamination), and the dough needs cold rests between every fold so the butter stays distinct and the gluten relaxes for the next roll. Start the night before. Mix flour, sugar, salt, fresh yeast, milk powder and cold water into a soft dough, knead just till smooth (don't overwork or the gluten will fight you later), rise 30 minutes till doubled at 24 C, knock back, then refrigerate 6 to 8 hours. The next day, cut a cross in the dough, roll out four ears, wrap them around a flat slab of butter that's the same temperature as the dough, then roll the package out to 40 by 70 cm, fold in three, refrigerate 20 minutes, repeat twice more in alternating directions. Roll out, cut into triangles using a template, stretch the corners, roll up from base to point, curve into crescents on a tray, egg-wash and proof at 24 to 30 C for two hours till doubled. Bake at 200 C till deep gold and shattering-crisp.
...
1. Place the flour in the bowl of the electric mixer, then at low speed, using the dough hook, beat in first the sugar and salt mixture, then the yeast mixture. 
1. Stop beating as soon as the ingredients are well mixed and the dough comes away from the sides of the bowl(This should take no longer than 1 ½ minutes) do not overwork the dough.
