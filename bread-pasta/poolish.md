...
## Overview
Poolish is the building block of properly flavoured French bread: a wet pre-ferment made the day before you bake, equal weights of flour and water with the smallest pinch of yeast (around half a gram), left to bubble away at room temperature for 12 to 18 hours. There's nothing technically demanding about it, but the long slow fermentation is doing two things that you can't replicate by any other shortcut. It develops the complex tangy back-flavour that turns a plain bread dough into something that tastes of bread rather than just yeast, and it builds extensibility in the gluten so the final dough rolls and stretches more willingly. Stir the tiny amount of yeast into 100 g of room-temperature water (around 20 to 22 C) for 20 seconds and let it sit a minute till slightly foamy. Tip 100 g of bread flour into a bowl, pour in the yeast water, then beat vigorously with a fork to a smooth pancake-batter consistency, no dry flour. Cover tightly with cling film (a crust forming on top would stop the action) and leave it somewhere warm and dry at 20 to 22 C for 16 to 18 hours, ideally; it'll triple in volume, fill with bubbles, and you'll notice the surface starting to dome and then sink slightly as the yeast tires. That sunken bubbled look is exactly what you want, and it's the signal to use it. When you mix the final dough, subtract the poolish's 100 g flour and 100 g water from whatever the recipe demands, then tip the whole bubbly mass into the bowl along with the rest of the flour, water and salt. The poolish keeps refrigerated up to three days if you can't bake straight away.
