...
1. The slash should be approximately ½ cm deep and run the entire length.
...
- **Scoring Depth:** The slash must be deep (at least ½ cm) to create the appearance of separation; shallow cuts won't create the desired effect.
