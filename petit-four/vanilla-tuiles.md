...
## Overview
Tuiles take their name from French roof tiles and curve to match: tissue-thin caramelised wafers spread paper-thin from a simple batter, baked till the edges blush gold, then draped over a rolling pin while still hot so they cool into elegant arcs you can perch beside a quenelle of ice cream or a fruit dessert. The batter is the easy part (cream soft butter with icing sugar, beat in egg whites one at a time, fold in self-raising flour and a splash of vanilla, then chill for an hour to let the gluten relax); the technique is everything else. Spread a teaspoon and a half through a 7 cm stencil onto parchment, so thin you can almost see through the layer, then bake at 170 C for eight to ten minutes till the edges turn pale gold and the centres stay barely coloured. The window between done and overbaked is about 30 seconds, so set a timer and watch the colour. The moment they come out, lift each one off with an offset spatula and drape it over a rolling pin or jar; it firms in 10 to 15 seconds into the classic curved tile. Work fast, because tuiles set brittle as they cool and won't shape once they've gone hard (and if one beats you, slip it back into the oven for 30 seconds to soften). Cool the curves on a rack till glass-crisp, store in a tin layered with parchment, and serve alongside ice cream, sorbet, a fruit dessert, or a small cup of strong coffee.
...
1. Beat in ½ teaspoon vanilla extract.
...
1. Using a silicone spatula, place a small amount of batter (approximately 1 ½-2 teaspoons) in the center of the stencil hole.
