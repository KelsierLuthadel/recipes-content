...
![BeaverTails](resources/beavertails.jpg)

*Ottawa's signature winter street-food: a hand-stretched flat oval of yeasted dough (shaped to look loosely like a beaver's tail), deep-fried till deep golden and puffed, then dusted generously with cinnamon-sugar or topped with any of a dozen variations (Reese's Pieces, chocolate hazelnut, maple cream, banana-and-chocolate). Sold from the BeaverTails kiosks on the frozen Rideau Canal during Ottawa Winterlude festival; widely imitated across Canada and now sold from Whistler to Quebec City. The frozen-canal December standard.*
...
## Overview
BeaverTails (the trademark is held by BeaverTails Canada Inc., who founded the kiosk chain in Ottawa in 1978; the generic name in Quebec is "queues de castor", same translation) are flat, hand-stretched, deep-fried doughnuts shaped to roughly resemble a flat beaver's tail. The construction is built around three specifics. First, the dough: a yeasted brioche-style dough enriched with butter, milk and a single egg, rolled out and stretched by hand to create an irregular oval about 25 cm long, 10 cm wide, with the long sides tapering slightly. The hand-stretching is important - the BeaverTail isn't a uniform disc; it's slightly uneven, slightly thicker in the middle than the edges, like a flatbread. Second, the fry: deep-fried in hot oil (180°C) for about 90 seconds per side - the dough puffs slightly and turns golden brown all over. Third, the topping: cinnamon-sugar is the canonical classic; the kiosk menu also includes Killaloe Sunrise (cinnamon-sugar + a drizzle of fresh lemon juice), the Choco-Hazelnut (Nutella), the Reese (peanut-butter cup chunks + chocolate), the Maple (maple butter spread + Skor toffee chips), the Apple Cinnamon (apple chunks + cinnamon-sugar), and the Banana-Chocolate. The dough must be made ahead - it needs at least 90 minutes for the first rise. Eaten hot from the fryer with the hands; the topping melts slightly from residual heat. Three details: HAND-STRETCH, DON'T ROLL UNIFORM (an uneven oval is the canonical shape; rolled-flat discs look like American funnel cakes, not Canadian BeaverTails), HOT OIL (180°C; lower and the dough soaks fat instead of frying), and TOPPING GOES ON WHILE HOT (the sugar sticks to the hot oily surface; cooled-then-topped doesn't have the same effect).
