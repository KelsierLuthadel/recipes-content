...
## Overview
The Montreal "all-dressed" hot dog (or "toute garnie" in French) is the signature Quebec take on the hot dog and a fixture of every Montreal casse-croûte (snack bar) - diners, dépanneurs and Belle Province / Lafleur quick-service chains all serve their version. The construction is more restrained than American regional dogs: a steamed all-beef frankfurter (steamed, never grilled; the snack-bar tradition uses commercial steamers running continuously through service) in a steamed New England-style top-split hot-dog bun (the bun has flat exterior sides that can be toasted, distinguishing it from American side-split buns), topped with the canonical "all-dressed" trio of yellow mustard, finely chopped raw onion, and finely shredded raw white cabbage (the cabbage is the Quebec-distinctive ingredient - finely shredded, eaten raw, almost slaw-like but undressed). Some snack-bar variants include sweet pickle relish; cheese-style versions add melted cheddar slices. The "steamé" (steamed) version is the canonical Montreal preparation; the "toasté" version with the bun toasted on the flat-top is the alternative. Three details: steamed (not grilled), New England top-split bun, shredded raw cabbage on top (not slaw).
