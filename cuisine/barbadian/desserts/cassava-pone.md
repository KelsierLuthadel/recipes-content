...
![Cassava Pone](resources/cassava-pone.jpg)

*Barbados's most identity-defining traditional sweet: a dense baked pudding made from grated cassava + grated coconut + grated sweet potato or pumpkin + soft brown sugar + butter + spices (cinnamon, nutmeg, mixed spice), poured into a tin and baked till the top forms a deep mahogany crust and the inside is chewy-dense, with the cassava giving it a slightly translucent gummy texture. The "pone" (from the West African / Native American word meaning a baked pudding) has been a Caribbean sweet since the 17th century. Sliced into hefty squares; eaten with a cup of strong Bajan tea or a glass of cold cocoa.*
...
## Overview
Cassava pone is one of the oldest and most-loved Caribbean sweets, with roots going back to the 17th century when Bajan slaves combined the cassava (an indigenous Caribbean starchy root) with the grated coconut, sugar and spices brought from West African and European trade. The construction has three Caribbean-specific moves. First, the cassava: fresh cassava (manioc / yuca) is the canonical starch base - peeled, grated finely (a box grater or food processor), and the released liquid SQUEEZED OUT (this is a critical and often-skipped step; raw cassava liquid contains trace cyanogenic compounds that are destroyed by cooking, but the dish texture is also helped by squeezing out the watery liquid). Outside the Caribbean, frozen grated cassava is sold at Latin American shops and works well; alternative is fresh cassava root from a Caribbean greengrocer. Second, the grated coconut: fresh grated coconut is canonical; desiccated unsweetened coconut works but doesn't have the same fresh-juicy character. The combination of grated cassava + grated coconut + grated sweet potato (or pumpkin) is the canonical Bajan trio - each grated to similar fineness so they bind together. Third, the spice mix: cinnamon, freshly grated nutmeg, mixed spice (or allspice), a touch of vanilla, and a generous pinch of salt - these are what distinguish the Caribbean pone from a generic cassava pudding. The pone is baked in a 23 × 23 cm tin at 180°C for 75 minutes till the top is deeply mahogany and slightly crackled, with the interior dense, chewy and almost slightly translucent. Cut into 12 squares; eaten as a tea-cake or dessert with a cup of strong Bajan tea. Three details: GRATE THE CASSAVA AND SQUEEZE OUT THE LIQUID (this is the canonical Bajan technique; helps the texture), USE FRESH GRATED COCONUT IF POSSIBLE (desiccated works but lacks the juicy character), and BAKE TILL THE TOP IS DEEP MAHOGANY (a pale crust means under-baked; the dark colour develops the deep caramelised flavour).
