...
- 2 large eggs, lightly beaten (for binding; traditional Bajan)
...
- **Processed cheese is optional but traditional:** the Bajan home version often uses a block of orange-coloured processed cheese (like Velveeta) alongside the cheddar. Pure cheddar works but the colour and meltability suffer.
