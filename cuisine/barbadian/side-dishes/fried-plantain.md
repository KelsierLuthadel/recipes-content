# Bajan Fried Plantain (Sweet Ripe Plantain Slices)
...
### The plantains
- 4 large very-ripe plantains (yellow skin with significant black spots; about 800 g total)
- About 5 tablespoons sunflower oil OR coconut oil OR rendered bacon fat (for shallow frying)

### To finish
- Fine sea salt (Maldon flakes ideal)
- A small pinch of ground cinnamon (optional; modern variant)

### To serve alongside
- Bajan stew chicken, Bajan fried chicken, oxtail stew, jerk chicken, or any Caribbean main
- Rice and peas
- Macaroni pie
...
2. DO NOT MOVE the slices for 2 minutes.
3. The undersides should become deep mahogany-gold and slightly caramelised at the edges.

### Stage 4 - Flip and fry the second side
1. With a spatula or tongs, gently flip each slice.
2. Cook the second side 2 minutes till also deep mahogany-gold.
3. The total cook time per slice should be 4-5 minutes (2 minutes + 2-3 minutes).
4. Lift onto kitchen paper to drain briefly.

### Stage 5 - Salt and serve
1. While the slices are still hot, sprinkle generously with fine sea salt (a small pinch over each slice; salt-sweet contrast is non-negotiable).
2. (Optional: dust with a tiny pinch of ground cinnamon for the modern variant.)
3. Pile on a warm platter.
