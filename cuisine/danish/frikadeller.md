...
### Brown sauce (brun sovs) - optional but traditional
- 40 g butter
- 4 tablespoons plain flour
...
- A few drops of kulør (Danish browning sauce) for the traditional dark colour, optional
...
2. Take a tablespoon (the traditional Danish dessert spoon).
...
7. Add a drop of kulør if you want the traditional deep brown colour.
...
## Notes
- **Pork-and-veal blend:** the traditional Danish ratio. All-pork works but is less complex.
- **Milk-soaked flour binder, not breadcrumbs:** the Danish difference from Swedish meatballs.
- **Wet spoon shaping:** the traditional Danish technique that gives the oval shape.
