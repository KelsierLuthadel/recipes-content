...
## Overview
Pakistan's beef samosa and the snack that anchors every iftar table and every roadside chai stall: triangular fried pastries stuffed with spiced beef mince and peas, served hot with tamarind and mint chutneys. Stiff dough is the technique here; samosa dough is much firmer than bread dough, and a wet soft dough gives oily soggy pastry while the stiffness gives the crisp flaky-but-firm shell. You whisk flour with salt and ajwain seeds (the carom that scents Pakistani samosa pastry), rub in cool ghee with fingertips to coarse breadcrumbs, add warm water gradually to a stiff dough (it shouldn't yield easily to a fingertip). Knead five minutes, rest 30 minutes. Brown beef mince with diced onion, ginger, garlic and green chilli, bloom turmeric, garam masala, cumin, coriander and Kashmiri chilli for a minute, add frozen peas and cook till the meat is dry but moist (no pooling liquid). Stir in coriander and lemon juice off the heat, cool fully (warm filling melts the ghee in the dough and the pastry collapses). Divide the dough into 10 balls, roll each into a thin 12 × 18 cm oval 2 mm thick, cut in half straight across to make two half-moons. Brush the straight edge of one half-moon with a flour-water paste, wrap into a cone shape with the overlap pressed firmly to seal. Hold the cone open-end up, spoon in a tablespoon of cooled filling, brush the top edge with paste, pinch closed and crimp with a fork. Deep-fry at 175°C four or five at a time, three or four minutes per side turning till amber-gold all over. Eat warm with tamarind chutney, mint chutney, lime wedges and sliced raw red onion.
