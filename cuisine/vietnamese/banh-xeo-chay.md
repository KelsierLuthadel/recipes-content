...
## Overview
Bánh xèo chay is the vegetarian version of Vietnam's "sizzling pancake": a crisp-edged turmeric-yellow disc of rice-flour batter folded around a stir-fry of mushrooms, tofu and beansprouts, torn into pieces and wrapped at the table in cool lettuce leaves with a handful of fresh herbs, dipped into a sweet-sour nước chấm. The name comes from the sizzle the batter makes when it hits the hot pan; the signature is the crackle of the lacy edges where the batter has thinned against the metal. The batter wants a 30-minute rest so the flour fully hydrates; skip it and the pancakes come out soft and chewy rather than crisp. Beansprouts go in on top once the disc is set, not into the batter, so they keep their crunch instead of going limp. Bring the pancakes, lettuce leaves and herbs (mint, coriander, Thai basil) to the table with the nước chấm; each diner tears off a piece, wraps it in a lettuce leaf with a sprig of each herb, dips and eats.
