...
1. Sprinkle the salt over.
1. Toss and rest for 15 minutes (water will drip out the bottom).
1. Squeeze gently and pat dry on a tea towel.

### Stage 2 - Assemble the salad
1. Transfer the cucumber to a bowl.
1. Add the grated coconut, green chilli, coriander, lime juice and a pinch of sugar.
1. Toss gently to combine.

### Stage 3 - Temper
1. Heat the coconut oil in a small pan over medium heat.
1. Add the mustard seeds; when they pop, add the dried red chilli and curry leaves.
1. Sizzle for 10 seconds.
1. Pull from the heat and stir in the asafoetida (if using).
