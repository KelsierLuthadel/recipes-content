...
## Overview
Mexico's defining dessert and the centrepiece of every quinceañera and Sunday family lunch: a silky baked custard sitting in a pool of bittersweet caramel that pours down the dome when you invert it onto a plate. The Mexican signature here is the milk trio (condensed, evaporated and whole) where European flan uses fresh cream, and it's what gives the dish its particular dense-silky texture and built-in sweetness. You melt sugar in a heavy pan over medium-high till it darkens to deep amber (espresso-coloured; pale caramel gives sweet syrup without depth, burnt caramel turns bitter, and it goes from amber to burnt in 30 seconds so watch carefully). Pour into a 22 cm round cake tin (solid-bottomed; not springform), tilt to coat the base and 1 cm up the sides, set aside as it hardens. Whisk eggs gently (don't whip; no foam), then the three milks, vanilla, salt and an optional spoon of rum. Strain through a fine sieve, skim any foam from the surface (foam gives a pocked finish), pour over the set caramel. Bake in a bain-marie at 160°C for 60 to 75 minutes till the edges are set firm but the centre has a slight jiggle; the water bath is non-negotiable, because direct oven heat overcooks the edges before the centre sets. Cool, refrigerate overnight, invert onto a plate the next day so the caramel pours over.
