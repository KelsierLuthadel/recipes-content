...
## Overview
Mexico's defining dessert and the centrepiece of every quinceañera and Sunday family lunch: a silky baked custard sitting in a pool of bittersweet caramel that pours down the dome when you invert it onto a plate. The Mexican signature is the milk trio: condensed, evaporated and whole: where European flan uses fresh cream, and it's what gives the dish its dense-silky texture and built-in sweetness. The caramel walks a fine line: sugar melted to a deep espresso-coloured amber, no further (it goes from amber to burnt bitterness in thirty seconds), poured into a solid-bottomed cake tin to set. Eggs go in gently: no whipping, no foam: with the three milks, vanilla, salt and an optional spoon of rum, then strained through a fine sieve and skimmed before pouring over the set caramel. A bain-marie is non-negotiable: direct oven heat overcooks the edges before the centre sets. Cooled, refrigerated overnight, inverted onto a plate the next day so the caramel runs.
