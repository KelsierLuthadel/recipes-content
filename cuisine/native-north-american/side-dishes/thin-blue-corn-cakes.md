...
## Overview
A home version of Hopi piki bread, the paper-thin blue cornmeal pancake cooked on hot stones across the Pueblo Southwest for hundreds of years: fine blue cornmeal whisked into a single-cream batter and spread paper-thin on a dry hot griddle, cooked till crisp at the edges. Traditional piki is cooked on a heated stone and rolled into a small scroll; this is the simpler home pan version, eaten alongside stew or wrapped around fillings. The pan must be dry, no oil, which is what gives the matte surface and slightly crisp edges. The batter wants to be the texture of single cream, and it sets within seconds of hitting the pan, so spread fast in a spiral from the centre outward. Baking soda stands in for the juniper ash that traditionally treats the cornmeal.
