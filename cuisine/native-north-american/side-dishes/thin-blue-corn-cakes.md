...
## Overview
A home version of Hopi piki bread, the paper-thin blue cornmeal pancake that's been cooked on hot stones across the Pueblo Southwest for hundreds of years: fine blue cornmeal whisked into a single-cream batter and spread paper-thin on a dry hot griddle, cooked till crisp at the edges. The traditional piki is cooked on a heated stone and rolled into a small scroll; this is the simpler home pan version, eaten alongside stew or wrapped around fillings. You whisk fine blue cornmeal with plain flour (for handleability), baking soda (standing in for juniper ash) and salt in a wide bowl. Pour just-off-the-boil hot water in a thin stream while whisking constantly to avoid lumps, add a spoon of sunflower oil. The batter should be runny, the texture of single cream (thin with more hot water a tablespoon at a time if too thick). Rest 10 minutes. Heat a wide flat non-stick pan or griddle over medium-high for three minutes; no oil, the pan must be dry, which is what gives the matte surface and slightly crisp edges. Ladle four tablespoons of batter into the centre with a wet metal spoon, immediately spread with the back of the spoon (or a thin spatula, or a wet hand) in a spiral motion outward into a 16 to 18 cm thin circle. Speed matters; the batter sets within seconds. Cook 60 to 75 seconds till the surface goes dry and the edges crisp, flip for 30 seconds. Stack under a clean tea towel to keep soft, stir the batter well between each (the cornmeal settles), serve warm.
