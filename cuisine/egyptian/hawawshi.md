...
1. Open each pita carefully along the edge to make a pocket (don't tear).
1. Stuff each with a quarter of the mince, pressing flat so it spreads evenly inside.
1. Press the pita closed; flatten with your palm.
...
1. Serve hot with tahini, pickles and salad.
