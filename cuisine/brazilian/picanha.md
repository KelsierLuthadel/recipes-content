...
## Overview
Picanha is the Brazilian gaucho tradition's most prized cut of beef - the "top-sirloin cap" (the triangular muscle that sits on top of the sirloin, with its thick layer of natural fat still attached). In Brazil, picanha is THE steak; it's served at every churrasco (the Brazilian barbecue tradition), every churrascaria restaurant, every gaucho weekend gathering across Rio Grande do Sul, and it's the centrepiece of the all-you-can-eat steakhouse experience that Brazilian-style restaurants have exported worldwide. The cut requires fresh fat-cap-intact picanha (typically 1-1.2 kg), salted GENEROUSLY on the fat side with coarse rock salt (just salt - no marinade, no garlic, nothing else; this is sacred), folded into a "C" shape with the fat on the outside, and skewered onto a long churrasco sword. Grilled over hot coals for 15-20 minutes total, the fat cap rendering and crisping, the meat developing a deep mahogany crust. Sliced thin (5 mm) against the grain at the table, each slice has a strip of crisp fat and a strip of medium-rare beef. Served simply: with farofa, white rice, vinaigrette molho (chopped tomato-onion-vinegar relish), and an ice-cold beer or caipirinha. Three details: BUY PROPER PICANHA WITH THE FAT CAP (a butcher's job; not a supermarket cut; the fat is the entire point - never trim it off), SALT GENEROUSLY (rock salt on the fat side only; the salt creates the crust and seasons through the rendering fat), and SLICE AGAINST THE GRAIN AT THE TABLE (across the muscle fibres, not with them - the slice technique is half the dish).
