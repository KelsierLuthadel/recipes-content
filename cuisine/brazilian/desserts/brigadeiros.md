...
## Overview
Brigadeiros (named after Brigadier Eduardo Gomes, a 1940s Brazilian political candidate; his supporters supposedly served the truffles at campaign events) are Brazil's most universally beloved dessert. Every Brazilian birthday party from infants to ninety-year-olds features a tray of brigadeiros; every Brazilian dessert table has them; every Brazilian schoolchild can name them; and every Brazilian grandmother has a signature method. The construction is brilliantly simple: one tin (397g) of sweetened condensed milk + 2 tablespoons of unsweetened cocoa powder + 30g of butter, simmered together in a heavy pan over medium heat, stirring constantly, for 12-15 minutes until the mixture thickens enough to "pull away from the pan" (the canonical Brazilian test - when you draw a wooden spoon through the mixture, the bottom of the pan should remain visible for 2-3 seconds before the mixture flows back). The thickened fudge is poured onto a buttered plate, cooled completely (2 hours minimum, or overnight), then rolled into walnut-sized balls with buttered hands. Each ball is rolled in chocolate sprinkles (the canonical coating - "granulado") and placed in a small paper case. The result is a soft, dense, dark-chocolate fudgy truffle that's both intensely Brazilian and instantly addictive. Three details: SIMMER UNTIL "PULLING AWAY FROM THE PAN" (the canonical test; under-cooked = too soft to roll; over-cooked = hard), USE GOOD COCOA (unsweetened cocoa; the cocoa flavour is the dish), and BUTTER YOUR HANDS BEFORE ROLLING (essential - the fudge is sticky).
