...
## Overview
Pudim de leite condensado (literally "condensed milk pudding"; sometimes called "pudim de leite" or simply "pudim") is the most beloved dessert in Brazil, present at virtually every Brazilian family Sunday lunch, every Brazilian birthday, every Brazilian wedding, every Brazilian Christmas, and every Brazilian buffet table. The construction is brilliantly simple but technically demanding: a ring tin (the canonical "forma de pudim" with the central tube) is coated with melted caramel; a custard of 1 tin sweetened condensed milk + 1 tin (same volume) of whole milk + 3 large eggs is blended together, strained, and poured carefully over the caramelised tin; the whole thing is baked in a bain-marie (water bath) at low heat for 1-1.5 hours; cooled, refrigerated overnight, and unmoulded at the last moment onto a serving plate. The result is a silky-smooth custard with a glossy amber caramel top, the caramel having flowed during baking to form a sauce around the unmoulded dome. The texture is unlike any other flan: dense, smooth, intensely creamy from the condensed milk, with a perfect proportion of caramel sweetness on top. Three details: WATER BATH IS NON-NEGOTIABLE (bain-marie at 160°C - bakes evenly without cracking; direct heat ruins it), DON'T OVERBAKE (the centre should still jiggle slightly when removed from the oven; it sets fully when refrigerated overnight), and CHILL OVERNIGHT before unmoulding (essential - gives the custard time to set properly; a 2-hour chill is not enough).
