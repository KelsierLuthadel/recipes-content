...
## Overview
The Palestinian falafel is the herb-heavy, vividly green sort, the one whose interior is bright with parsley and coriander when you bite through the amber crust. Dried chickpeas (or a chickpea-fava blend) soaked overnight with bicarbonate are essential; tinned chickpeas turn the paste into mush and the falafel into wet bricks. The herb amount is the defining feature; a generous handful each of parsley, coriander and dill is what gives the emerald interior, and skimping leaves the patties pale and ordinary. The texture is meant to be a coarse green paste with grain still visible, not a smooth puree. Baking soda goes in only just before frying, the bubbles it gives keeping the patties light. Sesame seeds pressed into one side of each patty crust up into the traditional craggy finish. Stuffed into warm khobz with tahini, sliced tomato and cucumber, romaine, pink pickled turnips, sumac and hot sauce, eaten standing up while the next batch is still hitting the oil.
