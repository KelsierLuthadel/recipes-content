...
## Overview
A dish defined by an honest premise: chillies and cheese, in roughly equal volume. The flavour is two things in tension - the fierce burn of green chillies (jalapeños standing in for the local Bhutanese varieties, which are hotter and more floral) and the funky, salty richness of blue cheese (Stilton or Gorgonzola standing in for traditional yak cheese, which is harder to find outside the Himalayas but tastes broadly similar in profile). The dairy fat tempers the burn just enough that you can actually eat it, but only just; the burn is the point. Beef, potato and tomato fill the dish out into a proper stew. Smell is roasted blue cheese and capsaicin, which is sharp and unmistakable. Easy cooking - everything goes in a pot together and simmers - but the heat tolerance required is real, and Western palates almost always halve the chilli count first time. The national dish of Bhutan, eaten with rice at most Bhutanese meals; in some Tibetan border regions a similar dish called churu (cheese soup) is made.
