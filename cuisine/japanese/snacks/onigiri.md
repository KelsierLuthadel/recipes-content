...
## Overview
The Japanese rice ball that lives in every convenience-store fridge, every bento box, every school lunch, and every train-station pick-up: salted short-grain rice pressed into triangles around a filling and wrapped in a strip of nori. You rinse short-grain Japanese rice till the water runs clear (long-grain won't hold the shape), let it rest, then cook with a 1:1.25 rice-to-water ratio and a tight-lidded pot; off the heat, rest covered another 10 minutes so the residual steam finishes the grain. Cool the rice to warm rather than hot (hands burn) or cold (rice doesn't compress). Wet both palms, dust them with salt, scoop a generous handful, dent the centre with a thumb, drop in a teaspoon of filling (umeboshi, salt-grilled salmon flake, tuna mayo, or kombu tsukudani), fold the rice up over the filling, and press into a flat triangle with firm-but-not-crushing pressure. Wrap a strip of nori around the base; if you're packing for later, leave the nori separate so it stays crisp. Eat at room temperature, by hand, within four hours.
