...
## Overview
Osaka's street-corner snack: small dashi-spiked batter balls cooked in a dimpled cast-iron pan around chunks of octopus, lacquered with sweet sauce and Kewpie, and finished with bonito flakes that curl and "dance" in the heat from the pile beneath. You'll need the pan; the half-spherical dimples are the whole point (aebleskiver pans are the closest substitute and work fine, but a flat pan can't make this dish). Whisk dashi, eggs, soy, mirin, salt and flour into a thin batter the consistency of single cream and rest briefly. Generously oil the pan and every dimple, pour batter to deliberately overflow each well, drop a chunk of cooked octopus, a pinch of pickled red ginger, a sprinkle of tenkasu (tempura crumbs) and chopped spring onion into each. After two or three minutes the bottoms set; the skill is then the skewer work, breaking the flat overflow around each ball, folding it into the dimple, rotating each one 90° to bring the wet top down into the well. It takes two or three batches to find the rhythm. Once each ball is round and golden, drizzle with takoyaki sauce and Kewpie, scatter bonito flakes and aonori, eat with toothpicks straight away. Caution: the centres are molten.
