...
## Overview
The small bowl of pickles that lands beside almost every Japanese meal: bright, salty, vinegared, a foil to the rice and the warmth of the main. These are asazuke (shallow pickles), the same-day quick brines rather than the long-fermented takuan or umeboshi; all three of the standard set (cucumber with kombu and sesame, daikon with lemon zest, cabbage with shiso) can be made in an afternoon for dinner. The technique is salt then weight then drain. The salt draws out water, the weight compresses, and what's left is concentrated vegetable with the seasonings clinging tight to the surface. Asazuke pickles want eating the same day; left longer they slide into more proper fermented territory and the bright fresh character gives way to deeper funk. Served each pickle in its own small bowl, cold, alongside rice and miso soup.

## Ingredients

### Pickle 1 - Cucumber (kyuri no asazuke)
- 2 Japanese (or Persian cucumbers, small, or ½ English cucumber, deseeded)
