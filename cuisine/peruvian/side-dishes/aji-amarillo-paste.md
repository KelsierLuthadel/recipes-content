...
![Aji Amarillo Paste](resources/aji-amarillo-paste.jpg)
...
## Overview
Aji amarillo paste is Peru's most identity-defining ingredient - the yellow-orange paste that defines the flavour profile of dozens of canonical Peruvian dishes. Without it, Peruvian cooking is just generic Andean food. With it, the dishes take on the unmistakable electric-yellow colour and floral-fruity heat that's distinctly Peruvian. The aji amarillo (Capsicum baccatum) is the country's signature chilli - a tapered, deep-orange pod about 8-10 cm long, with a Scoville heat of 30,000-50,000 (about half-as-hot as a serrano; less than a habanero). Unlike most chillies, the aji amarillo has a uniquely fruity, almost tropical-citrus aroma that's the dominant flavour note in the finished paste. The paste is made by blistering the chillies (some cooks boil them; some roast them; both work), peeling them (the skin is bitter), deseeding them (most of the heat is in the seeds), then blending the flesh with neutral oil, garlic and salt into a thick paste. The paste can be made fresh from whole pods (the canonical Peruvian way; aji amarillo pods are sold fresh in Latin American shops and increasingly online); OR rehydrated from dried aji amarillo pods; OR bought ready-made in jars (the Inka Crops, Doña Isabel and Goya brands are all widely available outside Peru and substitute well). This recipe makes the homemade-from-fresh version. The paste keeps refrigerated 2 weeks or freezes 6 months - useful since a single dish only uses 2-4 tablespoons. Three details: PEEL THE BLISTERED SKINS (the skin is bitter; this is non-negotiable), DESEED FOR HEAT CONTROL (most heat is in the seeds and the white ribs; deseed for a milder paste, leave seeds in for the heat lovers), and BLEND WITH OIL FOR PRESERVATION (the oil keeps the paste from oxidising; vacuum-sealed in oil it lasts months).
