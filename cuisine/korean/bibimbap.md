...
## Overview
Korea's rice bowl, the dish that tells you what kind of cook you are: warm rice topped with sautéed vegetables in colourful groups, a fried egg on top, optional bulgogi, and a generous spoon of gochujang sauce on the side. Bibim means mixed, bap means rice, and you do the mixing at the table, breaking the yolk into everything and folding it through till the colours blur. The work is in the separate-vegetable parade: spinach blanched and dressed with sesame oil and garlic, bean sprouts the same way, julienned carrot sautéed in sesame oil, mushrooms in soy and garlic, courgette quick-cooked, each going onto its own pile around the rice. The discrete colours and textures are the point; one undifferentiated stir-fry isn't the same dish. Slide a sunny-side-up egg on top, set a spoon of gochujang sauce on the side. A dolsot (hot stone bowl) version is worth investing in if this becomes regular; the rice catches into a crisp crust on the bottom as you mix.
