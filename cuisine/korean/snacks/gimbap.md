...
## Overview
Korea's lunchbox roll, the bento equivalent of the Korean kitchen: short-grain rice dressed in toasted sesame oil rolled with pickled yellow radish, spinach, julienned carrot, ham (or bulgogi, or tuna mayo) and a thin strip of egg inside a sheet of gim. The sesame-oil-on-rice distinction is the Korean signature; sesame oil and salt rather than the sushi-vinegar of Japanese maki is what makes gimbap taste Korean. Danmuji (pickled yellow radish) is the soul of the dish; the salty-sharp crunch separates a gimbap from a generic rice roll, and gimbap without danmuji misses its defining flavour. The lukewarm-rice rule is the technique home cooks new to rolling miss; steaming-hot rice steams the seaweed limp, cold rice splits when rolled, and lukewarm is the only window that works. Each filling preps separately so its colour stays distinct in the cross-section. Brushed outside with sesame oil, scattered with sesame seeds, sliced with a wet knife into ten to twelve rounds. Eaten at room temperature, the same day.
