...
## Overview
The Korean side dish that defines a meal: napa cabbage salted to wilt, packed leaf by leaf with a spiced paste of garlic, ginger, gochugaru, fish sauce and pear, then left to ferment for a few days before going into the fridge to deepen for weeks. The salt question is non-negotiable; coarse sea salt only, because table salt's iodine kills the lactobacillus that does all the fermentation work. The salting test is whether a stem bends without snapping; under-salted cabbage stays crunchy but won't ferment properly, over-salted cabbage goes too soft. A glutinous rice porridge bound through the spice paste is the canonical Korean technique that gives the paste body to cling to the leaves rather than running off, and skipping it is the most common home-cook mistake. The fruit (Asian pear or apple) is the sweetness source that balances gochugaru's heat. The fermentation works best loose-lidded on the counter for one to three days till bubbles rise, then into the fridge to deepen for weeks. Eaten with everything Korean.
