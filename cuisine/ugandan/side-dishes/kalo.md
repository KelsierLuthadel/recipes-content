...
## Overview
Kalo is the dense dark millet-and-cassava staple of eastern Uganda, particularly the Bagisu and Iteso peoples around Mount Elgon, where it counts as the traditional cousin to the whiter maize-meal posho eaten in central Buganda. Brown finger-millet flour and cassava flour are stirred together into boiling water and worked hard with a wooden paddle till the porridge stiffens into a dense earthy chocolate-coloured mass, then shaped into smooth flat discs the size of a side plate that diners tear pieces off, roll into small balls and use to scoop stew with the right hand. The flavour is distinctive and acquired: faintly fermented, slightly sour, deeply earthy from the millet, with the slightly elastic texture coming from the cassava flour. It eats best with groundnut sauces, smoked-fish stews and any rich savoury dish that benefits from the kalo's understated bitter-earthy character. Two ingredient details matter. First, use proper finger-millet flour (called bulo in Luganda, or wimbi in Swahili); it's the seed of finger millet (eleusine coracana) ground fine and has a distinctive russet-brown colour. Brown sorghum flour can substitute but tastes different; wholemeal wheat flour absolutely cannot. Second, the ratio of millet to cassava varies by region and family. The version below is a workable 70:30 millet-to-cassava blend; some families go 60:40 for a stretchier porridge, others 80:20 for a more pronounced millet character. Build the porridge the same way as posho: a slurry first, then build to stiffness with handful additions while you work hard with a wooden spoon. Cover and steam-finish to cook the inside through.
