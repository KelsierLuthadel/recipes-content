...
## Overview
Thai prawn toast is not the thin-smeared takeaway version: this is a proper prawn mountain piled high on a thick slice of baguette and deep-fried till the bread underneath turns golden and the prawn paste sets into a crisp scattered with sesame seeds. The pile is the dish: skimping on the topping defeats the whole point. The paste is processed prawns with finely chopped coriander stalks, kaffir lime, garlic, fish sauce, egg white and a teaspoon of sugar, blended till gooey like a soft dough, then mounded thick onto 2 cm slabs of baguette and pressed down firm. Sesame seeds scatter across each mound to toast in the oil. Fried prawn-side-down first so the topping sets, then flipped briefly to crisp the bread. Served hot with sweet chilli sauce for dipping.
