...
## Overview
Kanom chan is the Thai layer cake of wedding tables and auspicious occasions, alternating vivid-green pandan and creamy-white coconut layers stacked into a stripy jelly that you tear apart layer by layer with your fingers. Nine layers is the lucky number (odd numbers are preferred over even), though seven or eleven work just as well; the point is the patience to set each layer before the next one's poured. The texture comes from three starches working together: rice flour for body, tapioca starch for chew, mung-bean starch for the snap that lets you peel layers apart. Whisk all three with sugar, salt, coconut milk and water into a smooth lump-free batter, divide in two bowls, and add pandan extract or fresh pandan juice to one half for the green. Set a 20 cm square tin in a bamboo steamer over boiling water, pre-heat the tin two minutes, then pour the first 4 to 5 mm layer in and steam five or six minutes till matte and resilient. Without lifting the tin, pour the next colour straight on top, steam again, and keep alternating green-white-green-white till the batter's used (each layer must be fully set before the next or they bleed into a marble). Cover with a final 10 minutes of steam to finish, then cool to room temperature for an hour and chill at least two hours so the cake firms enough to slice. Cut into squares or 2 by 4 cm rectangles with an oiled knife, and eat at room temperature so the texture stays pliable; the traditional way is to pull the layers apart with your fingers, one at a time.
