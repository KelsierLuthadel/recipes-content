...
## Overview
Kanom chan is the Thai layer cake of wedding tables and auspicious occasions, vivid-green pandan and creamy-white coconut layers stacked into a stripy jelly you tear apart with your fingers. Nine layers is the lucky number (odd is preferred); the work is patience to set each layer before the next is poured. Three starches give the texture: rice flour for body, tapioca for chew, mung-bean for the snap that lets layers peel. Whisk all three with sugar, salt, coconut milk and water into a smooth batter; divide in two and tint one half with pandan. Pre-heat a 20 cm square tin in a bamboo steamer, pour a 4-5 mm layer, steam five or six minutes till matte and resilient, then pour the next colour straight on top. Keep alternating; if a layer isn't fully set the colours bleed. Finish with ten minutes of steam, cool an hour, chill two more, then cut with an oiled knife. Eat at room temperature and pull the layers apart one at a time.
