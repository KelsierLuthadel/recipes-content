...
## Overview
Ajad is the small bowl of sweet-sour cucumber relish that sits next to almost every fried snack on a Thai table, the bright pickled foil to chicken satay, fish cakes, prawn toast and curry puffs. The technique is dead simple but the proportions matter; the syrup wants to be a balanced sweet-sour-salty so the cucumber stays crisp rather than collapsing into mush. Bring rice vinegar (Thai or Japanese, never distilled white which is too sharp), palm sugar, water and salt just to a gentle simmer in a small saucepan, stir till the sugar dissolves, then cool completely to room temperature; pouring hot syrup over cucumber turns it limp in five minutes. While the syrup cools, peel the cucumber partially in stripes, halve lengthwise, scoop the seeds out with a teaspoon and slice 3 mm thick. Slice shallots as thin as you can manage and the bird's-eye chillies into fine rings (deseed for less heat). Combine cucumber, shallot and chilli in a wide bowl, pour the cooled syrup over and toss gently, then rest 10 to 15 minutes so the vegetables wilt slightly into the dressing without going limp. Transfer to small individual ramekins (one or two tablespoons per dipping bowl) for each guest, or pile into a larger bowl as a side, then scatter crushed roasted peanuts, fresh coriander and a pinch of toasted sesame seeds across the top. Eat the same day, ideally within four hours; ajad isn't a preserve, it's a quick-pickle that loses its crunch by the next morning.
