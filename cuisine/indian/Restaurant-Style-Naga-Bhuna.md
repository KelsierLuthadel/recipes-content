...
![Restaurant-Style Naga Bhuna Masala](resources/restaurant-style-naga-bhuna.jpg)
...
2. Drop in the tej patta, split cardamom pods, and cumin seeds.
3. Stir and fry for 30 to 45 seconds to infuse the oil.
...
2. Fry for 20 to 30 seconds, stirring constantly.
3. If the mixture dries out and starts sticking, splash in about 30 ml of base gravy. The spices need a touch of liquid to cook through properly.

### Stage 4 - Naga and tomato base
1. Turn the heat to high. Add the tomato paste, coriander stalks, the fresh chopped naga chilli (or naga pickle), and the optional red food colour.
2. If using pre-cooked chicken or lamb, add it now and mix well so every piece is coated in the masala.
...
1. About 1 minute before the end, drop the heat to low.
2. Stir in the natural yoghurt, mango chutney, and chopped coriander leaves.
3. Taste and adjust: more yoghurt to soften the heat, more chutney to sweeten, more salt for savoury depth.

### Stage 7 - Plate
1. Fish out the tej patta and green cardamom pods if you can spot them.
2. Spoon off any excess oil from the surface if you prefer a less rich finish.
3. Plate up with a slice of tomato or cucumber on the side and an extra scatter of coriander on top.
