...
## Overview
Pav bhaji is Mumbai's defining street food and the night-market plate that lives at every food cart on Marine Drive, Juhu Beach and Chowpatty: a thick, deep orange-red spiced vegetable mash scooped with soft white butter-griddled rolls (pav). The dish was invented in 1850s textile mills as a fast lunch for workers who needed something they could eat in a few minutes between shifts; it has stayed essentially the same dish ever since, just with a heavier hand of butter as the years went on. The bhaji is built on potatoes, cauliflower and peas mashed together with onion, tomato, capsicum and a generous spoon of pav bhaji masala (the specific commercial spice mix that gives the dish its flavour signature; substituting garam masala gives a different dish). The butter is non-negotiable. Mumbai street vendors use what looks like an obscene amount, and a domestic version that holds back tastes flat by comparison. Pav rolls split and griddle-fried hard in butter with a sprinkle of the masala for the proper Mumbai char. Eat from shallow bowls with raw onion, lemon and coriander piled on top.
