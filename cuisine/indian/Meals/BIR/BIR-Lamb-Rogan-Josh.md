...
1. Add garlic-ginger paste; sizzle 30 seconds, stirring.
1. Add paprika and chilli powder; fry 30 seconds until darker red.

### Stage 2 - Build sauce
1. Pour in tomato purée; bubble and cook down by half.
1. Stir in 250 ml (1 cup) base curry sauce, cumin, and mixed powder.
1. Simmer 2 mins, scraping caramelized bits from pan sides.

### Stage 3 - Add lamb and reduce
1. Add pre-cooked lamb, remaining base sauce, and stock.
1. Bring to boil; reduce to preferred consistency, stirring if catching.
1. Add tomato wedges.

### Stage 4 - Finish sauce
1. Swirl in cashew paste.
1. Add yoghurt 1 tbsp at a time, stirring continuously.
1. Sprinkle kasoori methi and garam masala; season with salt.
