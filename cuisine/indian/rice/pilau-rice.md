...
- 8 whole cloves
- 1 cinnamon stick (approximately 2 ½ cm / 1 inch long)
...
- Fine sea salt to taste (approximately ½ teaspoon)
...
1. Add approximately ½ teaspoon fine sea salt to taste (adjust based on stock's saltiness; if using pre-salted stock, reduce).
