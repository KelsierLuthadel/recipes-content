...
1. Add the dried red chillies and toast for 30 seconds.
1. Add the sesame seeds; toast for 30 seconds (until they start to pop).
1. Cool completely, then grind to a coarse powder.

### Stage 3 - Cook the tamarind paste
1. Pour the tamarind extract into a small pan.
1. Add the turmeric, jaggery and salt.
1. Bring to a simmer and cook for 5-6 minutes, stirring, until thick enough to coat a spoon.
1. Stir in 2 tablespoons of the spice powder; cook for 1 more minute.
1. Pull from the heat (reserve the remaining spice powder for the rice).

### Stage 4 - Temper
1. Heat the sesame oil in a wide pan over medium heat.
1. Add the mustard seeds; when they pop, add the peanuts.
1. Cook for 2-3 minutes until the peanuts turn pale gold.
1. Add the urad dal, chana dal and dried red chillies; cook for 30 seconds until the dals turn golden.
1. Add the curry leaves and asafoetida; sizzle for 5 seconds.

### Stage 5 - Combine
1. Pull the pan from the heat.
1. Add the tamarind paste to the tempered oil and stir to combine.
1. Add the cooked rice in two batches, folding gently.
1. Sprinkle the remaining spice powder over.
1. Toss until every grain is coated.
...
1. Serve at room temperature with a side of yogurt or potato roast.
