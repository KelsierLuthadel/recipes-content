...
## Overview
Jordan's open-top meat pastries: small yeasted discs topped with raw spiced lamb mince and pinched into a four-cornered star shape, the Jordanian visual signature that distinguishes them from the flat-edged Lebanese lahem-bi-ajeen. The lamb cooks on the dough in the high oven with no pre-frying, so the meat stays juicy and the dough crisps beneath. The raw-onion technique is the detail home cooks miss; grated onion must be squeezed bone-dry before mixing, because wet onion soaks the dough soft and the pastry never crisps. Pomegranate molasses in the topping is the Jordanian touch (rather than the Syrian tamarind or Lebanese lemon-only finish) and gives the characteristic sweet-sour glaze. A small test piece pan-cooked first to taste-and-adjust before topping any dough is the worth-doing-every-time habit, because raw mince can't be re-seasoned after it's spread. Served warm with lemon wedges, a small bowl of yogurt and an extra scatter of pomegranate seeds across the platter.
