...
![Belgian Pralines](resources/belgian-pralines.jpg)

*Belgium's most famous chocolate export: a thin shell of tempered Belgian chocolate filled with a soft centre, traditionally a praliné (caramelised hazelnut paste), gianduja (chocolate-hazelnut blend), or a flavoured ganache (vanilla, coffee, raspberry, Champagne). Distinct from the Swiss truffle or French bonbon: the Belgian praline has a thin crisp shell and a generous soft centre, hand-moulded since Jean Neuhaus II invented the technique in Brussels in 1912.*
...
## Overview
A Belgian praline is what most of the world simply calls "a Belgian chocolate" - the gold standard of moulded chocolate confectionery. The word "praline" can be confusing: in French it usually means caramelised nuts in candy form; in American English it's a New Orleans pecan-and-caramel patty. In Belgium, "une praline" specifically means a moulded chocolate shell filled with a soft centre. The invention is credited to Jean Neuhaus II in Brussels in 1912, when he developed a chocolate shell sturdy enough to hold a soft filling without breaking - the precursor to every filled chocolate sold today. The construction has three stages. First, the temper: high-quality Belgian dark or milk couverture chocolate (Callebaut is the workhorse; Belcolade and Cacao Barry are the artisan options) heated and cooled through specific temperature curves so the cocoa butter crystallises into the stable Form V structure - this gives the chocolate its glossy snap and prevents bloom. Second, the shell-moulding: pour tempered chocolate into a polycarbonate praline mould, invert to drain out the excess (leaving a 2-3 mm shell coating the cavity walls), let set. Third, the filling: pipe a soft ganache (or praliné paste, or gianduja) into the set shells, then cap with another layer of tempered chocolate. The praline rests 4-6 hours till the cap sets, then unmoulds with a gentle tap. The fillings are where the cook's creativity shows: classic dark ganache, milk-chocolate praliné, white-chocolate raspberry, hazelnut gianduja, Champagne truffle, coffee ganache. Three details: TEMPER PROPERLY (Form V crystallisation gives the snap, the gloss, and prevents the dull white bloom; this is the technical heart of pralinerie), USE PROFESSIONAL POLYCARBONATE MOULDS (silicone moulds don't give the same gloss; cheap plastic moulds warp), and FILL AT THE RIGHT TEMPERATURE (the ganache must be at 28-30°C; too hot and it melts the shell; too cool and it doesn't pipe smoothly).
