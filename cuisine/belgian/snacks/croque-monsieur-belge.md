...
## Overview
The croque monsieur is French in origin, invented around 1910 at a Paris café, but the Belgian version distinguishes itself with three moves. The ham must be Belgian Ardennes ham (smoked, slightly sweet, fine-textured) or a good Belgian cooked ham like jambon de Liège, rather than the French jambon blanc; the smoke note is what gives the Belgian version its character. The cheese choice leans to Gruyère and Emmental together, often with a layer of Bruges Vieux or aged Gouda for depth, where a single-cheese build gives a flatter result. The béchamel-cheese gratin topping is the Brussels-brasserie signature that takes the dish from a plain pan-toasted sandwich into something closer to a croque madame's elaborate cousin; baked under the grill till bubbling and dark gold, this finishing step is what separates a Belgian croque from any other ham-and-cheese toastie. The result is heavier and richer than the French original. Served with frites and a small green salad; a fried egg on top turns it into a croque madame Belge.
