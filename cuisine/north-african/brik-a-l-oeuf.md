...
## Overview
Tunisia's signature street food, sold from every Sidi Bou Said cart and every Tunis lunch counter: a thin sheet of malsouka pastry wrapped around tuna, capers, parsley and a whole egg, deep-fried fast so the yolk runs when you bite into it. The runny yolk is the point: a brik with a fully-set yolk is overcooked. The filling is chunky drained tuna with finely chopped onion, parsley, capers, optional parmesan, harissa, cumin and pepper, spread on one half of a malsouka sheet (two stacked filo sheets brushed with oil between substitute). A well in the centre cradles a whole cracked egg, then the empty half folds over and the edges press shut with a fork. Slid straight into 180 °C oil and fried sixty to ninety seconds a side till deep gold and crisp: any delay and the egg leaks. Served immediately with lemon wedges, a smear of harissa and a simple green salad. Eaten by hand: bite a corner and let the yolk run.
