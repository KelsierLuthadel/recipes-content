...
## Overview
Mondongo is one of Colombia's most beloved soup-stews and the canonical Antioqueño (paisa region) tripe specialty: honeycomb tripe is first thoroughly cleaned, blanched, and pre-cooked in flavoured water till tender (this is the labour-intensive step), then slow-cooked together with chorizo, beef ribs (or shanks), the canonical Colombian hogao (onion-tomato-pepper sauce), cubed plantain, potato, cassava/yuca, corn on the cob, carrot and a generous handful of fresh coriander till everything is fork-tender and the broth thickens to a deeply savoury orange stew. Served in deep bowls with sliced avocado, sliced banana (yes, banana - the Colombian twist), a pile of plain white rice on the side, and a fresh arepa for mopping. The dish has a serious reputation across Colombia as both Sunday family food and the canonical hangover cure (along with caldo de costilla); paisa Colombians swear by it. Three details define proper mondongo. First, the tripe must be properly cleaned and pre-cooked. This is the most labour-intensive step; tripe needs thorough rinsing, scrubbing with lemon and salt, then slow-cooking in a flavoured base for 90 minutes to remove any off-flavours and tenderise. Skipping this step gives a rubbery off-tasting soup. Second, the multiple-protein base. Tripe + chorizo + beef ribs is canonical; the combination gives the proper layered savoury depth. Third, the topping. Sliced avocado and sliced banana on top, served with white rice and arepa on the side. This combination distinguishes Colombian mondongo from Spanish tripe soups (callos).
