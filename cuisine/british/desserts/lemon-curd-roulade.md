...
![Lemon Curd Roulade](resources/lemon-curd-roulade.jpg)
...
## Overview
Lemon curd meringue roulade is one of British baking's most enduringly popular dinner-party desserts and a Mary Berry / Great British Bake Off signature dish. The construction has three components: a meringue base baked thin on a tray (whisked egg whites + sugar + a touch of cornflour and vinegar to keep the inside marshmallow-soft, baked at 180°C for 8 minutes then 160°C for 10 more, just long enough that the top crisps to a pale-golden shell while the inside stays squishy), a tangy homemade lemon curd (egg yolks + butter + lemon juice + sugar + zest cooked over a bain-marie till thickened to a thick custard), and a layer of lightly whipped double cream. Once the meringue cools, it's flipped out onto a sheet of greaseproof paper dusted with icing sugar, spread thinly with cooled lemon curd, then covered with whipped cream, and rolled tightly from the short side using the paper to lift and tuck. Refrigerated 30 minutes for the roll to set, then sliced into thick discs that show the yellow lemon-curd spiral against the white cream and crisp golden outside. The dessert is gluten-free (no flour), serves 8 generously, can be made a day ahead, and looks impressive on a flat plate dusted with extra icing sugar. Three details: cornflour-and-vinegar in the meringue (the secret to the soft-inside-crisp-outside texture), homemade lemon curd (don't use shop-bought; the curd is the heart of the dish), tight roll using the paper to guide it (the spiral must show in the slice).
