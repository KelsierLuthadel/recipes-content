...
## Overview
Käsekrainer is the cheese-stuffed sausage that defines late-night Vienna street food, a coarse-ground pork and beef sausage in a natural casing with small cubes of Emmentaler or Bergkäse worked through the meat so they melt into hot oozing pockets when the sausage hits the grill. They were created in Vienna in the 1960s as a variation on the classic Krainer Wurst (a sausage with origins in the Krain region of Slovenia), and they've since become so identified with the city that one is on the menu of every Würstelstand from Albertinaplatz to the Naschmarkt. The traditional service is theatrical: the sausage is grilled or pan-fried till the skin blisters and the cheese inside is properly molten, then split lengthwise on a wooden board, laid splayed-open into a halved kaiser roll or alongside a Buchtel-style bread end, smeared with sweet mustard, dotted with curry ketchup, and topped with sliced pickled gherkins. The split is so the diner gets the cheese-oozing inside face-up rather than hidden. This recipe assumes you're starting from quality pre-made Käsekrainer (they're widely available at good European butchers and increasingly at supermarkets in continental Europe); making the sausage from scratch is a separate undertaking entirely. The focus here is the proper cooking and serving.
