...
## Overview
Key wat (sometimes called siga wat) is Ethiopia's deep-red beef stew, the meaty Sunday-and-feast-day counterpart to the chicken-based doro wat: cubed beef simmered slowly with onions collapsed into a sweet base, berbere stirred in to build the signature dark-red sauce, niter kibbeh stirred through for richness, and a generous quantity of garlic, ginger and fresh chilli. "Key" means red in Amharic; "wat" means stew. The most-served Sunday lunch across the Ethiopian highlands, eaten on injera with gomen (collards), atakilt (cabbage and potato), ayib (cottage cheese) and tibs on a shared platter. The dish lives or dies on the onion base. Two large onions per kilogram of meat, finely sliced, sweated dry in a heavy pot for 20 to 25 minutes (no oil at first; this is "the onion cook") till they collapse into a soft sweet pale-brown mass. Only then does the niter kibbeh go in, and the berbere blooms in it till the oil turns deep red. Hard-boiled eggs simmered in the sauce for the last fifteen minutes are an iconic addition.
