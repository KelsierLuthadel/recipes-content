...
## Overview
Injera is the foundational bread of Ethiopia (and Eritrea), a large round of fermented teff flour batter cooked on a hot mitad griddle into a pale grey-brown flatbread covered in thousands of tiny bubble holes (the "eyes" or insira); it's the plate, the bread and the eating utensil all at once. Every Ethiopian and Eritrean meal is built around injera: the bread serves as the platter that wats, tibs and gomen are arranged on, and diners tear pieces of the bread with the right hand to scoop the stews and meats off the plate. The defining flavour is the gentle sour tang from the wild-yeast fermentation; injera proper is made from 100 percent teff flour (a tiny Ethiopian grain ground into a fine flour) that's mixed with water and left to ferment for 2-4 days before cooking. The result is unmistakable: a faintly sour spongy flatbread that pairs beautifully with the rich spicy stews it carries. Three details define a proper injera. First, the teff. True injera is 100 percent teff flour (ideally a mix of white and brown teff for the classic colour), and any substitution with wheat or other flours moves the result toward a generic crepe. Outside Ethiopia, 100 percent teff flour is available from Ethiopian shops and increasingly from health-food stores. Second, the long fermentation. The batter is mixed with warm water and left in a warm spot for 2-4 days till it develops the proper sour smell and surface bubbles. Skipping the fermentation gives you a flat unspongy flatbread without the sour character that defines injera. Third, the dry hot griddle. Injera is cooked on a flat griddle (a mitad in Ethiopia; a flat 30 cm non-stick pan or large cast-iron crepe pan as substitutes) at moderate-high heat, covered briefly, never flipped. The batter is poured from the outside spiralling inward, the lid goes on for 90 seconds, and the bread is lifted off when the top is set and the bottom has just released. This recipe makes the home-cook approximation. The proper restaurant version takes a starter that's been kept alive for months; the home version uses a quick-ferment approach that gets you 80 percent of the way in 2-4 days.
