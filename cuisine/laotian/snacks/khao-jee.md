# Khao Jee Paté (Lao Baguette Sandwich)
...
### The bread (4 sandwiches)
- 4 small Lao or Vietnamese baguette rolls (about 15-20 cm long; slightly day-old)
- (Or 1 large French baguette cut into 4 pieces, lightly toasted)

### The pickled carrot-daikon (do-chua)
- 1 large carrot, julienned (or coarsely grated)
- 200 g daikon radish, julienned (or coarsely grated)
- 60 ml rice vinegar
- 60 ml water
- 30 g caster sugar
- 1 teaspoon salt
...
- OR 200 g shredded cold poached chicken
- OR a few generous spoonfuls of laap

### The fresh garnish
- A small bunch fresh cilantro
- A small bunch fresh mint
- A few sprigs culantro (sawtooth coriander) if available
- 1 cucumber, peeled into long thin ribbons (or sliced)
...
### To serve
- Sticky rice on the side (optional, the Lao way)
- A glass of Lao iced coffee (café Lao)

## Method

### Stage 1 - Pickle the carrot-daikon
1. Combine the julienned carrot and daikon in a bowl.
2. Whisk the rice vinegar, water, sugar and salt together; pour over.
3. Toss to coat; let stand 30 minutes (the vegetables soften and absorb the brine).
4. Drain before using.

### Stage 2 - Mix the dressing
1. Whisk together the soy sauce, padaek, lime juice, palm sugar and white pepper.

### Stage 3 - Prep the bread
1. Split each baguette roll lengthways without cutting all the way through (a hinge cut).
2. If the bread is fresh, lightly toast the cut sides in a dry pan or under a grill for 30 seconds.

### Stage 4 - Assemble each sandwich
1. Open the roll.
2. Spread one cut side generously with pâté.
3. Spread the other side with mayo (or butter) + a small smear of Dijon.
4. Lay 2-3 thick slices of sai oua (or other meat) along the length.
5. Pile a generous fork of pickled carrot-daikon on top.
6. Add a few cucumber ribbons.
7. Pile fresh cilantro, mint, culantro and spring onion on top.
8. Add a few chilli rings.
9. Drizzle 1 tablespoon of the Lao dressing over.
10. Close the roll; press gently.

### Stage 5 - Serve immediately
1. Cut each sandwich in half on the diagonal.
2. Serve with a glass of Lao iced coffee.
