...
![Bife a lo Pobre](resources/bife-a-lo-pobre.jpg)
...
## Overview
Bife a lo pobre (literally "poor man's steak"; though the dish is actually quite extravagant in its components) is the canonical Chilean and Argentine working-class plate and a beloved diner classic in both countries: a thick beef steak (usually sirloin or ribeye, sometimes a thinner cut for the everyday version) grilled to medium-rare, plated alongside a heap of hand-cut fried potatoes (papas fritas; not chips, but proper hand-cut fries), two sunny-side-up fried eggs (with runny yolks), and a heap of sautéed sliced onions; the whole plate is meant to fill a Chilean working-man (or Argentine, depending on which side of the Andes you're on) for the full afternoon. The name "a lo pobre" (poor man's) is ironic given the substantial size of the plate; the origin is that this was a worker's filling lunch in the early 20th century when steak was relatively affordable in Chile and Argentina, served with whatever could pad it out (potatoes, eggs, onions). Three details define proper bife a lo pobre. First, all four components on the same plate. The steak, fries, eggs and onions are presented together; it's the combination that defines the dish. Second, hand-cut fries. Not bagged frozen chips; proper hand-cut fries from real potatoes, twice-fried for the proper crispness. Third, sunny-side-up eggs with runny yolks. The yolk runs into the steak and fries; the runniness is the point.
