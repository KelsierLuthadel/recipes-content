...
## Overview
Melktert is the South African milk tart, an Afrikaans tea-time staple: a thin pastry shell holding a delicate cinnamon-scented milk custard set firm enough to slice, dusted heavily with cinnamon just before it reaches the table. The signature of melktert is restraint. The custard should be sliceable but still wobble gently when you cut it, never the heavy egg custard of an English tart. The cinnamon goes on at the end as a dust, not baked in (where it would turn bitter). The milk infuses with butter and a cinnamon stick first; resting off the heat is where the perfume comes from, so don't skip it. Cooled to room temperature, then dusted generously with cinnamon (or cinnamon-sugar) through a fine sieve just before serving with strong rooibos tea.
