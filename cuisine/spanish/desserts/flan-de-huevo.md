...
## Overview
Flan de huevo is Spain's national pudding, the lighter-and-more-eggy cousin to the French crème caramel and the Filipino leche flan, a caramel-amber custard inverted onto a plate at the table so the syrup runs down the dome in glossy ribbons. The Spanish version uses whole eggs rather than just yolks, which gives the custard a cleaner less-rich character, with a couple of extra yolks added for body. Start with the caramel: dissolve sugar in two tablespoons of water in a small heavy pan and cook over medium heat without stirring for six to eight minutes, swirling occasionally, till the syrup turns deep amber. Working fast (it goes from amber to burnt in seconds), pour into six ramekins tilting each to coat the bottom, set aside to harden. Warm the milk with a strip of lemon peel and a split vanilla pod just to a simmer, cover and infuse 15 minutes off the heat. Whisk the eggs and extra yolks gently with sugar (no aerating, beaten eggs leave air bubbles in the set custard), then strain the warm infused milk into the eggs while whisking, and strain the whole mixture again through a fine sieve into a jug. Pour over the hardened caramel in each ramekin, cover with foil, then bake in a deep dish with hot water reaching halfway up the sides at 150°C for 40 to 45 minutes till just set with a slight wobble. Cool fully and chill at least four hours and ideally overnight, then run a thin knife around each edge and invert onto a small plate; the caramel pours down like a glaze.
