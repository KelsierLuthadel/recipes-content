...
## Overview
Flan con dulce de leche is the Argentine dessert that wins all the polls: the most universally beloved sweet finale in the country, served at every restaurant, every Sunday family lunch, every wedding, every birthday party. The construction combines two of Argentina's great sweets: a classic flan (milk, sugar, eggs, vanilla, baked in a caramelised tin in a bain-marie till set, chilled, unmoulded), and a generous spoon of dulce de leche piled on top. The flan itself is identical in technique to the Brazilian pudim de leite condensado, but the topping transforms it. Where the Brazilian version's only sweetness is the caramel sauce flowing from the tin, the Argentine version layers dulce de leche on top, so the dessert has two caramel components at once. Plated: a slice of flan surrounded by caramel sauce, topped with a generous quenelle of dulce de leche, finished with softly whipped cream.
