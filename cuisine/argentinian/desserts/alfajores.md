...
## Overview
Alfajores are Argentina's most universally beloved biscuit - the canonical "with-coffee" snack at every Argentine merienda (tea-time), the country's most exported food, and present at every children's birthday party, every wedding favour, and every supermarket biscuit aisle. The dish has Spanish-Moorish roots (the name comes from the Arabic "al-hashu" meaning "the stuffed one") and arrived in Argentina via Spanish colonists; the Argentine version was refined into its modern form in the 19th and 20th centuries. The construction has three components: two short crumbly biscuits made with a high proportion of cornflour to plain flour (the cornflour gives the canonical "melt-in-mouth" tender crumb; sometimes called "alfajores de maicena" for this reason), bound with butter, sugar, egg yolks, vanilla and a touch of lemon zest; a thick layer of dulce de leche sandwiched between two biscuits; and a coating - either rolled in desiccated coconut around the visible dulce edge (the canonical "alfajores de maicena" version) or dipped in chocolate (the "alfajor chocolate" version). The biscuits are baked till just pale-golden - barely coloured - to maintain the soft melt-in-mouth quality. The dulce filling is generous; about a tablespoon per alfajor. Three details: HIGH RATIO OF CORNFLOUR (50/50 cornflour to plain flour gives the canonical tender crumb), BAKE PALE (don't brown - the biscuits should be barely coloured), and GENEROUS DULCE FILLING (no skimping; the dulce is the star).
